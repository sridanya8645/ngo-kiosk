            ...
            <div className="event-section">
              ...
              {todaysEvent.banner && (
                <div className="event-banner">
                  <img src={`http://localhost:5000${todaysEvent.banner}`} alt="Event Banner" className="event-banner-img" />
                </div>
              )}
            </div>
          )}
            ...
            <div className="newsletter-section">
              ...
              {newsletterEvent.banner && (
                <div className="newsletter-banner">
                  <img src={`http://localhost:5000${newsletterEvent.banner}`} alt="Newsletter Banner" className="newsletter-banner-img" />
                </div>
              )}
            </div>
          )}
